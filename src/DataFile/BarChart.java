...
public final class BarChart extends JFrame {
    ...
    public BarChart(String title , String []lineVerticals , int []n,String strSquare,String y_axis,String x_axis) {
        super(title);
        this.ChartTitle=title;
        final CategoryDataset dataset = CreateDataSet(lineVerticals, n,strSquare);
    ...
    private CategoryDataset CreateDataSet(String []lineVerticals , int []n,String series)
    {
        final String Series = series;
        final DefaultCategoryDataset dataset = new DefaultCategoryDataset();
        for(int i=0 ; i<lineVerticals.length ; i++)//line.length
            dataset.addValue(n[i], Series, lineVerticals[i]);
        return dataset;
    }
